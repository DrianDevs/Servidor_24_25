...
{
    if (isset($_SESSION['horarios_clases'][$clase][$dia]) && $_SESSION['horarios_clases'][$clase][$dia]['plazas_disponibles'] > 0 && $_SESSION['horarios_clases'][$clase][$dia]['reservado'] == 0) {
...
{
    if (isset($_SESSION['horarios_clases'][$clase][$dia]) && $_SESSION['horarios_clase'][$clase][$dia]['plazas_reservadas'] > 1) {
        ++$_SESSION['horarios_clases'][$clase][$dia]['plazas_disponibles'];
        --$_SESSION['horarios_clases'][$clase][$dia]['plazas_reservadas'];
