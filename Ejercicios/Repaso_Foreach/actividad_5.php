    ...
    <table border="1">
        ...
        <tbody>
            ...
            foreach ($comunidades as $comunidad => $datos) {
                ...
                foreach ($datos['provincias'] as $provincia => $datos_provincia) {
                    $poblacion_provincia += $datos_provincia['poblacion'];
                }
                echo "<td>$poblacion_provincia</td>";
            }
            ?>
        </tbody>
    </table>
